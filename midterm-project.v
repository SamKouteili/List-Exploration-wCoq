...
Definition test_copy (candidate : forall V : Type, list V -> list V) :=
  ...
  (eqb_list bool Bool.eqb (candidate bool (false :: false :: true :: false :: true :: nil)) (false :: false :: true :: false :: true :: nil)).
...
Definition test_append (candidate : forall V : Type, list V -> list V -> list V) : bool :=
  ...
  (eqb_list bool Bool.eqb (candidate bool (false :: true :: nil) (true :: true :: false :: nil)) (false :: true :: true :: true :: false :: nil)) &&
  (eqb_list nat Nat.eqb (candidate nat (3 :: 5 :: nil) (6 :: 7 :: 8 :: nil)) (3 :: 5 :: 6 :: 7 :: 8 :: nil)) &&
  (eqb_list bool Bool.eqb (candidate bool (true :: nil )(false :: false :: true :: false :: true :: nil)) (true :: false :: false :: true :: false :: true :: nil)).
...
Definition test_reverse (candidate : forall V : Type, list V -> list V) :=
  ...
  (eqb_list bool Bool.eqb (candidate bool (false :: false :: false :: true :: false :: true :: nil)) (true :: false :: true :: false :: false :: false :: nil)).
(*
...
(* Proof by induction *)
Lemma about_cons_and_append :
  forall (V : Type)
         (v : V)
         (v1s v2s : list V),
    v :: (append_v0 V v1s v2s) = append_v0 V (v :: v1s) v2s.
Proof.
  intros V v v1s.
  revert v.
  induction v1s as [ | v1 v1s' IHv1s'].
  - intros v v2s.
    rewrite -> (fold_unfold_append_v0_cons V v nil).
    rewrite -> (fold_unfold_append_v0_nil V v2s).
    reflexivity.
  - intros v v2s.
    rewrite -> (fold_unfold_append_v0_cons V v1 v1s' v2s).
    rewrite -> (IHv1s' v1 v2s).
    rewrite -> (fold_unfold_append_v0_cons V v (v1 :: v1s') v2s).
    reflexivity.
Qed.
...
Proof.
  ...
  - intro a.
    ...
    rewrite -> (IHvs' (v :: nil)).
    (* try to get the same nunber of append_v0 on each side of the goal, so that we can compare them *)
    rewrite <- (nil_is_neutral_on_append_v0_left V a) at 1.
    rewrite -> (about_cons_and_append V v nil a).
...
Proof.
  ...
  - intros [ | n'] H_length.
    ...
    -- rewrite -> (fold_unfold_map_v0_cons V W f v vs').
       ...
       --- reflexivity.
       --- rewrite -> (fold_unfold_length_v0_cons V v vs') in H_length.
           exact (Nat.succ_inj (length_v0 V vs') n' H_length).
Qed.
...
(* foo is the identity function for lists *)
